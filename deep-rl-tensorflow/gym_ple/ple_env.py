...
class PLEEnv(gym.Env):
    ...
    def __init__(self, game_name='FlappyBird', display_screen=True, num_of_agents=1):
        ...
        self.action_space = spaces.Discrete(len(self._action_set)+num_of_agents-1) #adding null action for each agent
